...
}:
{
  ...
  programs.zsh = {
    ...
    shellAliases = {
      e = "nvim";
      update-nixos = "sudo nixos-rebuild switch --flake ${config.home.homeDirectory}/Repos/nixos-config";
      upgrade-nixos = "nix flake update --flake ${config.home.homeDirectory}/Repos/nixos-config && sudo nixos-rebuild switch --flake ${config.home.homeDirectory}/Repos/nixos-config";
